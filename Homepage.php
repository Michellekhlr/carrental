...
<!DOCTYPE html>
<head>
    <title>Startseite - Drive.</title><link rel="icon" type="image/png" href="bilder/Drive.png">
...
<body>
    ...
    <div class="hintergrundschnellsuche"> 
        ...
        <script>//Only display additional filters if "Mehr Filter" is pressed, otherwise they should not be visible.
            function toggleMenu() {
    ...
    <div class="newsletter">
        ...
        <div>
            ...
            <form class="newsletterform"><!--Formular, für das Abonnieren des Newsletter. Formular ist nicht funktional.-->
