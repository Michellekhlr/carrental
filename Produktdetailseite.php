    ...
    <div class="extras">
        ...
        <div class="extrabuchung">
            <div class="versicherung">
                    ...
                    <label id="checkboxfilter1">All-Inclusive
                        <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
    
                    
                    <label id="checkboxfilter2">Teilkasko
                        <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
    
                
                    <label id="checkboxfilter3">Basic
                        <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
            ...
            <div class="zubehoer">
                <div class="zubehoerueberschrift">
                    ...
                    <label id="checkboxfilter1">Kindersitz
                    <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
    
                    <label id="checkboxfilter2">Fahrradträger
                        <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
    
                    <label id="checkboxfilter3">Dachbox
                    <input type="checkbox" class="checkmarkcolumn">
                    </label><br>
